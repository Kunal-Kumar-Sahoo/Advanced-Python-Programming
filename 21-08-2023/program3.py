"""
Ceate a command-line interface that allows users to input a command, execute it as a subprocess, 
...
"""
#With Popen() insted of run(): we need to use communicate() with Peopn
